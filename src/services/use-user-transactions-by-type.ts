...
export function useUserTransactionsByType(userId: string | null, transactionTypeId: string | null) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/users/${userId}/transactions/transaction-types/${transactionTypeId}`, {
        method: 'GET',
        headers: {
